...
env_params_train = {'initial_velocity': 15,
...
env_params_test = {'initial_velocity': 18,
                   'initial_flight_path_angle': -6,
                   'initial_altitude': 30,
                   'dt': 0.01,
                   't_max': 20,
                   't_switch': 30}
env_params_test['step_switch'] = int(env_params_test['t_switch'] / env_params_test['dt'])
env_params_test['n_steps'] = int(env_params_test['t_max'] / env_params_test['dt'])
